<template>
    <div>
        <modal width="60%" height="auto" :scrollable="true" :pivotY="0.2" :clickToClose="false" name="edit-employee">
            <div class="flex justify-end">
                <i @click="$modal.hide('edit-employee')" class="vs-icon vs-popup--close material-icons text-warning"
