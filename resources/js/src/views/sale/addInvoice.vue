                    ...
                    <vx-card
                        ...
                        <div
                            ...
                            <div
                                ...
                                <vx-input-group>
                                    <v-select
                                        :filterBy="searchCustomer"
                                        v-model="invoice.customer"
                                        label="name"
                                        name="customer"
                                        v-validate="'required'"
                                        :options="all_customer">
                                        <template
                                    ...
                                    <template
                                        ...
                                        <q-icon name="event"
                                            ...
                                            <q-popup-proxy
                                                ...
                                                <q-date v-model="invoice.invoice_date"
                        ...
                        <div
                            ...
                            <div
                                ...
                                Amount
                                <span
                                    class="text-6xl block">${{invoice.total_balance}}</span>
                            </div>
                        </div>
                        <vs-divider
                            position="left">
                        ...
                        <table
                            ...
                            <tbody>
                            <tr :key="index"
                                v-for="(tr, index) in invoice.items">
                                <td class="py-1">
                                    {{index+1}}
                                </td>
                                <td width="600">
                                ...
                                <td>
                                    <vs-input-number
                                        color="danger"
                                        v-if="tr.inventory_type==='service'"
                                        v-model="tr.qty"
                                        min="0"
                                        :name="`qty-${index}`"
                                        v-validate="'required'"/>
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <vs-input-number
                                            color="warning"
                                            v-model="invoice.balance"
                                            min="0"
                                            :max="invoice.total_balance"
                                ...
                                <vs-divider
                                    position="left">
                                    <vs-checkbox
                                        v-model="invoice.is_bundle">
                                        ទំនិញដំុ?
                                    </vs-checkbox>
                                </vs-divider>
                                <div
                                    class="vx-row"
                                    v-if="invoice.is_bundle">
                                    <div
                                        class="vx-col md:w-1/2 w-full">
                                        <label>តម្លៃទិញ</label>
                                        <vs-input-number
                                            v-model="invoice.purchase_amount"
                                            min="0"
                                            label="តម្លៃទិញ:"/>
                                    </div>
                                    <div
