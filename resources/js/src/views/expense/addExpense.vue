<template>
    <modal width="60%" height="auto" :scrollable="true" :pivotY="0.2" :clickToClose="false" name="add-expense">
        <div class="flex justify-end">
            <i @click="$modal.hide('add-expense')" class="vs-icon vs-popup--close material-icons text-warning" style="background: rgb(255, 255, 255);">close</i>
        </div>
        <vx-card no-shadow>
            <div class="vx-row">
